...
const features = [
  ...
  },
  {
    ...
    headline: "Automatic Course Data",
    body: "Course photos, club logos, and public/private/resort classification pulled automatically. 15,000+ courses in the database.",
  },
  {
    icon: (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
